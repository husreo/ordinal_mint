        ...
        <div className='modal flex flex-col gap-3 bg-black p-2'>
          ...
          <div className='flex flex-col gap-2'>
            <div className='flex flex-col'>
              ...
              <span className='text-lg'>(Taproot format recommended)</span>
            </div>
            <div className='text-base text-white/70'>
              Enter an Ordinals supported wallet address. If your wallet does
              not support Ordinals or you are not sure, you can use the web
              wallet from this link: https://ordinalswallet.com/
            </div>{' '}
            <input
              className='rounded-md bg-transparent text-xl'
              name='address'
          ...
          <Button disabled className='order-1 mt-6 md:order-2'>
            Mint
          </Button>
        </div>
      </Popup>
