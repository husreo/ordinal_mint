        ...
        <section className='relative mb-10 flex flex-col items-center gap-7 md:gap-12 md:pt-32'>
          {!isValid ? (
            <div className='flex flex-col gap-3 p-2'>
              ...
              <Button className='mt-6' disabled onClick={checkValid}>
                Mint soon
              </Button>
            </div>
          ) : (
            <div className='flex flex-col'>
              <div
                ...
                className='mt-5 mb-4 cursor-pointer'
              >
                <span>{'<'} Back</span>
              </div>
              <h3>Payment</h3>
              <div className='flex flex-col gap-4'>
                <div className='flex flex-col items-stretch gap-1'>
                  ...
                  <div className='flex flex-row items-stretch'>
                    ...
                    <input
                      ref={inputRefValue}
                      className='grow rounded-r-md bg-transparent text-2xl md:text-center'
                      type='number'
                      readOnly
                ...
                <div className='flex flex-col items-stretch gap-1'>
                  ...
                  <div className='flex flex-row items-stretch'>
                    ...
                    <input
                      ref={inputRefAddress}
                      className='grow rounded-r-md bg-transparent text-2xl'
                      type='text'
                      readOnly
