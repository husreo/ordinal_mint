  ...
  return (
    <Layout href='/'>
      ...
      <main className='layout min-h-screen'>
        <section className='relative flex flex-col items-center gap-16 pt-32 text-center'>
          <h1 className='p-2 text-center'>
            Ordinal
            <br /> Skulls
          </h1>
          <p className='w-[34rem] text-xl'>
          ...
          <div className='flex flex-col items-center justify-center gap-3'>
            ...
            <span className='font-matrix text-xl'>120/300</span>
          </div>
        </section>
